...
def Chatting():
    training = pd.read_csv('app/Chat/Training.csv')
    testing= pd.read_csv('app/Chat/Testing.csv')
    ...
    def getDescription():
        ...
        with open('app/Chat/symptom_Description.csv') as csv_file:
    ...
    def getSeverityDict():
        ...
        with open('app/Chat/symptom_severity.csv') as csv_file:
    ...
    def getprecautionDict():
        ...
        with open('app/Chat/symptom_precaution.csv') as csv_file:
    ...
    def sec_predict(symptoms_exp):
        df = pd.read_csv('app/Chat/Training.csv')
        X = df.iloc[:, :-1]
        y = df['prognosis']
